 ...
 * android.content.Intent; import android.os.Bundle; import android.os.Handler;
 * import android.os.Message; import android.os.Vibrator; import
 * android.view.KeyEvent; import android.view.View; import android.view.Window;
 * import android.widget.ImageButton; import android.widget.ImageView; import
 * android.widget.Toast;
 * 
 * import com.nhncorp.student.sawonjungfinder.R; import
 * com.nhncorp.student.sawonjungfinder.R.drawable; import
 * com.nhncorp.student.sawonjungfinder.constants.Constants; import
 * com.nhncorp.student.sawonjungfinder.map.MapActivity;
 * 
 ...
 * 
 * private Thread myThread = null; private boolean runThread = true;
 * 
 * int countVibrator = 0;
 * 
 * @Override public boolean onKeyDown(int keyCode, KeyEvent keyEvent) { if
 * (keyEvent.getAction() == KeyEvent.ACTION_DOWN) { switch (keyCode) { case
 * KeyEvent.KEYCODE_BACK: if (myThread != null && myThread.isAlive()) {
 * runThread = false; } this.finish();
 * 
 * } } return false; }
 * 
 ...
 * setContentView(R.layout.activity_finder); init();
 * 
 * }
 * 
 * private void init() { confirmService(); getView(); addListener();
 * 
 * }
 * 
 * private void addListener() { mapBtn.setOnClickListener(new
 * View.OnClickListener() {
 * 
 * @Override public void onClick(View v) { Intent intent = new
 * Intent(FinderActivity.this, MapActivity.class); startActivity(intent);
 * 
 * } });
 * 
 * }
 * 
 * private void confirmService() { if (Constants.DEVICE_STATE.equals("1")) { }
 * else if (Constants.DEVICE_STATE.equals("0")) { Toast.makeText(this,
 * "서비스가 꺼져있습니다.", Toast.LENGTH_LONG).show(); }
 * 
 * }
 * 
 ...
 * 
 * @Override public void handleMessage(Message msg) { updateThread(); } };
 * 
 * @Override protected void onStart() { super.onStart(); myThread = new
 * Thread(new Runnable() { public void run() { while (runThread) { try {
 * handler.sendMessage(handler.obtainMessage()); Thread.sleep(100); } catch
 * (Throwable t) { } } } }); if (Constants.DEVICE_STATE.equals("1")) {
 * myThread.start(); } }
 * 
 ...
 * }
 * 
 * } else { distanceMessage.setBackgroundResource(drawable.message2);
 * 
 * countVibrator = 0;
 * 
 * }
